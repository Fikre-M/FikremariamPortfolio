    ...
    <>
      <style>{`
        ...
        .marquee-text {
          ...
          animation: marquee 18s linear infinite, colorShift 4s ease-in-out infinite;
          white-space: nowrap;
          font-weight: 600;
          font-size: 0.95rem;
        }
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900 border-t border-gray-700 px-4 py-3 flex items-center gap-3 shadow-lg overflow-hidden">
        ...
        <button
          ...
          className="shrink-0 p-1 text-gray-400 hover:text-white hover:bg-gray-700 rounded transition-colors duration-200"
          aria-label="Dismiss"
        >
          <FaTimes />
        </button>
